...
<div class="row">
	<div class="span12">
    <ul class="breadcrumb">
		<li><a href="#">Trang chủ<sa> <span class="divider">/</span></li>
	...
	<table class="table table-bordered table-condensed">
              ...
              <tbody>
			   ...
			   <c:forEach var="item" items="${ Cart }">
				<tr>
                  <td><img width="100" src="<c:url value="/assets/user/img/${ item.value.product.img }"></c:url>" alt=""></td>
				  ...
				  <td>
					...
					<td>
					<a href="<c:url value="/DeleteCart/${ item.key }"></c:url>" class="btn btn-mini btn-danger" type="button">
